...
MISLIBR = [
    "Не смог найти Вашу книгу, но не переживайте: скоро она появится в моём каталоге! Попробуйте назвать другую книгу, и Я постараюсь её найти. Если вы не хотите смотреть книги, скажите \"Меню\".",
    "Вашей книги нет в каталоге, но скоро Я её туда добавлю. Назовите другую книгу, и Я поищу её! Не забывайте, чтобы выйти в меню, достаточно сказать \"Меню\"."
]
MISLIBR_INTO = [
