...
MISLIBR = [
    "Упс, не смог найти Вашу книгу, но не переживайте: скоро она появится в моём каталоге! Попробуйте назвать другую книгу, и Я постараюсь её найти. Если вы не хотите смотреть книги, скажите \"Меню\".",
    "Ой! Вашей книги нет в каталоге, но скоро Я её туда добавлю. Назовите другую книгу, и Я поищу её! Не забывайте, чтобы выйти в меню, достаточно сказать \"Меню\"."
]
MISLIBR_INTO = [
    "Извините, но такого пункта в меню нет. Пожалуйста, выберите один из доступных вариантов: ",
    " информация, Персонажи из книги, Интересные факты. Вы можете вернуться обратно на витрину и выбрать другую книгу. "
    "Для этого скажите Витрина.",
    "К сожалению, выбранный вами пункт не найден. Пожалуйста, выберите один из доступных вариантов: ",
    "Основная информация, Персонажи из книги, Интересные факты. Вы можете вернуться обратно на витрину и "
    ...
    "Персонажи из книги, Интересные факты. Вы можете вернуться обратно на витрину и выбрать другую книгу. "
    "Для этого скажите Витрина.",
...
def return_books(res: dict) -> dict:
    ...
    text = f'Скажите название интересующей Вас книги или выберите одну из пяти предложенных: ' \
           ...
           f'Чтобы посмотреть другие книги, скажите "Дальше".'
    res = save_response(
        res=res,
        text=text,
        tts=text,
...
def get_book_reference(res: dict, book: str) -> dict:
    ...
    text = f'Вы выбрали произведение {book}. Скажите, что хотите узнать о данном произведении. Я могу' \
           ...
           f'Для этого скажите "Витрина". Если хотите, чтобы я повторил, скажите "Повтори". ' \
