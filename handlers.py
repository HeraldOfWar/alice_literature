...
WRONGANS = [
    "Упс! Вы ответили неверно...", "Жаль, что ваш ответ не был верным. Но вы почти правы!",
    "Неверный ответ.", "Увы, ваш ответ оказался мимо кассы.",
    "Вы ошиблись.", "Нет, ваш ответ неверен, как Анна Каренина, бросившаяся под поезд.",
    "Не хотел я этого говорить, но Вы ошиблись.",
    "К сожалению, ваш ответ был не тот, что нужен, как Родион Раскольников, принимающий ошибочное решение.",
    ...
    "Неправильно, но не переживайте, этот вопрос будет проще.",
    "Очень близко, но не совсем.", "Ваш ответ был как шерсть на зубах – не совсем то, что нужно.",
    "К сожалению, ваш ответ был настолько неверен, что Шерлок Холмс воскликнул бы \"Элементарно, Ватсон, что это неправильно!\"",
    "Хотелось бы, чтобы ваш ответ был верен, но он так же далек от правильного, как Нептун от Меркурия.",
    "Как в \"Анне Карениной\" Толстого, ваш ответ был ошибкой, приведшей к трагическим последствиям.",
    "К сожалению, ваш ответ был так неверен, что он бы заставил героя романа \"Идиот\" Достоевского покрутить головой."
]
TRUEANS = ["Правильно!", "Верно!", "Абсолютно точно!", "Ты молодец! Всё правильно.", "Вы великолепны, правильно!",
           "Вы правы!", "Как вы это сделали, верно!", "Я просто удивлён, верно!",
           ...
           "Превосходно, вы владеете знаниями, как Дон Кихот владеет мечом.", "Верно, как заряд в пистолете у Чехова.",
           "Точно, как слова в романе-эпопее \"Война и мир\" Толстого."]
